...
const configurations: Record<EnvironmentState, EnvironmentConfig> = {
  home: { density: 16, movement: 0.18, connectionDistance: 105, connectionOpacity: 0.08, pointerRadius: 55, clustering: 0.05 },
  work: { density: 32, movement: 0.24, connectionDistance: 125, connectionOpacity: 0.13, pointerRadius: 65, clustering: 0.18 },
  project: { density: 24, movement: 0.2, connectionDistance: 110, connectionOpacity: 0.1, pointerRadius: 58, clustering: 0.16 },
  experience: { density: 24, movement: 0.27, connectionDistance: 115, connectionOpacity: 0.1, pointerRadius: 55, clustering: 0.1 },
  stack: { density: 38, movement: 0.21, connectionDistance: 120, connectionOpacity: 0.12, pointerRadius: 62, clustering: 0.2 },
  about: { density: 14, movement: 0.14, connectionDistance: 100, connectionOpacity: 0.06, pointerRadius: 48, clustering: 0.04 },
  contact: { density: 10, movement: 0.1, connectionDistance: 90, connectionOpacity: 0.05, pointerRadius: 44, clustering: 0.02 },
};
